...
LocalDB = {}
ch_markup = InlineKeyboardMarkup([[InlineKeyboardButton(text="Updates Channel", url="https://t.me/BATTLE_GROUP_OF_HEXA"),
                                    InlineKeyboardButton(text="Support Group", url="https://t.me/MyBotsupport")]])
